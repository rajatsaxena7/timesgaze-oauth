...
app.get(
  ...
  (req, res) => {
    // Extract tokens and redirect to custom scheme
    ...
    const redirectUrl = `timesgaze://callback?accessToken=${accessToken}&refreshToken=${refreshToken}&profile=${encodeURIComponent(JSON.stringify(profile))}`;
